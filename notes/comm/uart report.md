...
| 2024-01-23 | 0.3 | Karlo | spelling checking +  |
<!-- |  |  |  |  | -->
...
the number of bits is configurable for the data bits, parity bits and the stop bits, and any unsupported number will be cautght using a static_assert.
